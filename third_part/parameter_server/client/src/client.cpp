...
int main(int argc, char** argv) {
  std::shared_ptr<tcmcp_psProxyServClient> client(new tcmcp_psProxyServClient(
      "127.0.0.1:2183", "/psProxy/tcmcp/flash_training_1112_online", 1,
      120 * 1000 * 1000));
  client->init();
  int ret;
  // std::string return_val;
  // std::cout << "ret " << client->tcmcp_backup(return_val, "scp", "1102") <<
  // std::endl; std::cout << return_val << std::endl; sleep(2);
