...
#define log_trace(fmt, ...)                                               \
  util::log_write(util::Logger::kLevelTrace, "%s(%d): " fmt, __FILE_NAME, \
                  __LINE__, __VA_ARGS__)
#define log_debug(fmt, ...)                                               \
  util::log_write(util::Logger::kLevelDebug, "%s(%d): " fmt, __FILE_NAME, \
                  __LINE__, __VA_ARGS__)
#define log_info(fmt, ...)                                               \
  util::log_write(util::Logger::kLevelInfo, "%s(%d): " fmt, __FILE_NAME, \
                  __LINE__, __VA_ARGS__)
#define log_warn(fmt, ...)                                               \
  util::log_write(util::Logger::kLevelWarn, "%s(%d): " fmt, __FILE_NAME, \
                  __LINE__, __VA_ARGS__)
#define log_error(fmt, ...)                                               \
  util::log_write(util::Logger::kLevelError, "%s(%d): " fmt, __FILE_NAME, \
                  __LINE__, __VA_ARGS__)
#define log_fatal(fmt, ...)                                               \
  util::log_write(util::Logger::kLevelFatal, "%s(%d): " fmt, __FILE_NAME, \
                  __LINE__, __VA_ARGS__)
