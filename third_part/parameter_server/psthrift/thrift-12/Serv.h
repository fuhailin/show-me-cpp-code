...
class Serv_push_args {
 public:
  ...
  Serv_push_args(const Serv_push_args&);
  Serv_push_args& operator=(const Serv_push_args&);
  Serv_push_args() {
  }
...
class Serv_sync_push_args {
 public:
  ...
  Serv_sync_push_args(const Serv_sync_push_args&);
  Serv_sync_push_args& operator=(const Serv_sync_push_args&);
  Serv_sync_push_args() {
  }
...
class Serv_sync_push_result {
 public:
  ...
  Serv_sync_push_result(const Serv_sync_push_result&);
  Serv_sync_push_result& operator=(const Serv_sync_push_result&);
...
class Serv_pushemb_args {
 public:
  ...
  Serv_pushemb_args(const Serv_pushemb_args&);
  Serv_pushemb_args& operator=(const Serv_pushemb_args&);
  Serv_pushemb_args() {
  }
...
class Serv_pushemb_result {
 public:
  ...
  Serv_pushemb_result(const Serv_pushemb_result&);
  Serv_pushemb_result& operator=(const Serv_pushemb_result&);
  Serv_pushemb_result() {
  }
...
class Serv_pushada_args {
 public:
  ...
  Serv_pushada_args(const Serv_pushada_args&);
  Serv_pushada_args& operator=(const Serv_pushada_args&);
  Serv_pushada_args() {
  }
...
class Serv_pushada_result {
 public:
  ...
  Serv_pushada_result(const Serv_pushada_result&);
  Serv_pushada_result& operator=(const Serv_pushada_result&);
  Serv_pushada_result() {
  }
...
class Serv_pull_args {
 public:
  ...
  Serv_pull_args(const Serv_pull_args&);
  Serv_pull_args& operator=(const Serv_pull_args&);
  Serv_pull_args() {
  }
...
class Serv_pull_result {
 public:
  ...
  Serv_pull_result(const Serv_pull_result&);
  Serv_pull_result& operator=(const Serv_pull_result&);
  Serv_pull_result() {
  }
...
class Serv_pull_online_args {
 public:
  ...
  Serv_pull_online_args(const Serv_pull_online_args&);
  Serv_pull_online_args& operator=(const Serv_pull_online_args&);
...
class Serv_pull_online_result {
 public:
  ...
  Serv_pull_online_result(const Serv_pull_online_result&);
  Serv_pull_online_result& operator=(const Serv_pull_online_result&);
...
class Serv_heartbeat_args {
 public:
  ...
  Serv_heartbeat_args(const Serv_heartbeat_args&);
  Serv_heartbeat_args& operator=(const Serv_heartbeat_args&);
...
class Serv_heartbeat_result {
 public:
  ...
  Serv_heartbeat_result(const Serv_heartbeat_result&);
  Serv_heartbeat_result& operator=(const Serv_heartbeat_result&);
