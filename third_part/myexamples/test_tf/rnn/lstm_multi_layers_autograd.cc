...
int main() {
  ...
  auto apply_w_layer1 =
      ApplyAdagradTrick(root, w_layer1, ada_w_layer1, lr, grad_outputs[0]);
  auto apply_b_layer1 =
      ApplyAdagradTrick(root, b_layer1, ada_b_layer1, lr, grad_outputs[1]);
  auto apply_w_layer2 =
      ApplyAdagradTrick(root, w_layer2, ada_w_layer2, lr, grad_outputs[2]);
  auto apply_b_layer2 =
      ApplyAdagradTrick(root, b_layer2, ada_b_layer2, lr, grad_outputs[3]);
