...
int main(int argc, const char *argv[]) {
    ...
    Status s;
    string proto_name = "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/frozen/cnn.pb";
    ...
    if (!use_frozen) {
        ...
        string base_folder = "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/data/cats_and_dogs_small/train";
        int batch_size = 20;
        ...
        base_folder = "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/data/cats_and_dogs_small/validation";
        ...
        TF_CHECK_OK(CreateSummaryFileWriter(1, 0, "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/graphs/loss/", "loss", Env::Default(), &w1));
        TF_CHECK_OK(CreateSummaryFileWriter(1, 0, "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/graphs/accu/", "loss", Env::Default(), &w2));
        TF_CHECK_OK(CreateSummaryFileWriter(1, 0, "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/graphs/valid/", "loss", Env::Default(), &w3));
        ...
        for (int epoch = 0; epoch < num_epochs; epoch++) {
            ...
            for (int b = 0; b < num_batches; b++) {
                ...
                float loss;
                if (augment_data) {
                    TF_CHECK_OK(model.WriteBatchToImageFiles(image_batches[b], "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/data/cats_and_dogs_small", "source"));
                    Tensor augmented;
                    TF_CHECK_OK(model.RandomAugmentBatch(image_batches[b], augmented));
                    TF_CHECK_OK(model.WriteBatchToImageFiles(augmented, "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/data/cats_and_dogs_small", "augmented"));
            ...
            cout << endl
                 << "Time: " << duration_cast<seconds>(t2 - t1).count() << " seconds ";
        ...
        TF_CHECK_OK(s);
        base_folder = "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/data/cats_and_dogs_small/test";
    ...
    } else  //use the frozen model
    {
        ...
        s = model.CreateGraphForImage(false);  //rebuild the image loading model without unstacking
        TF_CHECK_OK(s);
        string base_folder = "/Users/vincent/Documents/projects/show-me-cpp-code/cpp-tutorial/myexamples/test_tf/CatDogCNN/data/cats_and_dogs_small/test";
        vector<pair<Tensor, float>> all_files_tensors;
        s = model.ReadFileTensors(base_folder, {make_pair("cats", 0), make_pair("dogs", 1)}, all_files_tensors);
        TF_CHECK_OK(s);
        //test the images
