...
service EchoService {
    MockResponse echo(1: MockRequest req) throws (1:MockException ex) (cpp.coroutine) ;
    MockResponse ping(1: MockRequest req) throws (1:MockException ex);
    // Oneway methods can't throw exceptions.
    oneway void oneway_echo(1: MockRequest req)(cpp.coroutine);
}
