...
class Optimizer : Layer {
 public:
  virtual void push(std::vector<ull> feas,
                    std::vector<std::vector<double>> &vals){};

  virtual int pull(std::vector<ull> feas,
  ...
  virtual void push_over(std::vector<ull> feas,
                         std::vector<std::vector<double>> &vals){};
};

class SGD : public Optimizer {
 public:
  SGD() { load_conf(global_conf()["optimizer"]); }
...
class Adagrad : public SGD {
 public:
  Adagrad() { load_conf(global_conf()["optimizer"]); }
