...
class HelloSvcIfSingletonFactory : virtual public HelloSvcIfFactory {
 public:
  HelloSvcIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<HelloSvcIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<HelloSvcIf> iface_;
};
...
class HelloSvc_hello_func_args {
 public:
  ...
  virtual ~HelloSvc_hello_func_args() throw();
...
class HelloSvc_hello_func_pargs {
 public:
  ...
  virtual ~HelloSvc_hello_func_pargs() throw();
...
class HelloSvc_hello_func_result {
 public:
  ...
  virtual ~HelloSvc_hello_func_result() throw();
  std::string success;
...
class HelloSvc_hello_func_presult {
 public:
  ...
  virtual ~HelloSvc_hello_func_presult() throw();
  std::string* success;
...
class HelloSvc_hello_func2_args {
 public:
  ...
  virtual ~HelloSvc_hello_func2_args() throw();
  std::string var1;
  int64_t var2;
...
class HelloSvc_hello_func2_pargs {
 public:
  ...
  virtual ~HelloSvc_hello_func2_pargs() throw();
...
class HelloSvc_hello_func2_result {
 public:
  ...
  virtual ~HelloSvc_hello_func2_result() throw();
...
class HelloSvc_hello_func2_presult {
 public:
  ...
  virtual ~HelloSvc_hello_func2_presult() throw();
...
class HelloSvc_hello_func3_args {
 public:
  ...
  virtual ~HelloSvc_hello_func3_args() throw();
  std::string var1;
...
class HelloSvc_hello_func3_pargs {
 public:
  ...
  virtual ~HelloSvc_hello_func3_pargs() throw();
  const std::string* var1;
...
class HelloSvcClient : virtual public HelloSvcIf {
 public:
  HelloSvcClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  HelloSvcClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class HelloSvcProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  HelloSvcProcessor(::apache::thrift::stdcxx::shared_ptr<HelloSvcIf> iface) :
    iface_(iface) {
...
class HelloSvcProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  HelloSvcProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< HelloSvcIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< HelloSvcIfFactory > handlerFactory_;
};

class HelloSvcMultiface : virtual public HelloSvcIf {
 public:
  HelloSvcMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<HelloSvcIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~HelloSvcMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<HelloSvcIf> > ifaces_;
  HelloSvcMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<HelloSvcIf> iface) {
...
class HelloSvcConcurrentClient : virtual public HelloSvcIf {
 public:
  HelloSvcConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  HelloSvcConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
