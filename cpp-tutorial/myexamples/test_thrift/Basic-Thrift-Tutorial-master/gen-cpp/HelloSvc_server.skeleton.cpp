...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<HelloSvcHandler> handler(new HelloSvcHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new HelloSvcProcessor(handler));
