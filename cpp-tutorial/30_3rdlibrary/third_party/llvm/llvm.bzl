...
def expand_cmake_vars(name, src, dst, cmake_vars):
    ...
    Args:
      ...
      cmake_vars: a string containing the CMake variables, as generated by
        cmake_var_string.
    """
    expand_cmake_vars_tool = "@cc_third_party//llvm:expand_cmake_vars"
    native.genrule(
        name = name,
        srcs = [src],
...
llvm_all_cmake_vars = select({
    "@cc_third_party//tensorflow:macos": cmake_var_string(
        _dict_add(
            cmake_vars,
    ...
    "@cc_third_party//tensorflow:linux_ppc64le": cmake_var_string(
        _dict_add(
            cmake_vars,
    ...
    "@cc_third_party//tensorflow:windows": cmake_var_string(
        _dict_add(
            cmake_vars,
    ...
    "@cc_third_party//tensorflow:freebsd": cmake_var_string(
        _dict_add(
            cmake_vars,
    ...
    "@cc_third_party//tensorflow:linux_s390x": cmake_var_string(
        _dict_add(
            cmake_vars,
...
llvm_linkopts = select({
    "@cc_third_party//tensorflow:windows": [],
    "@cc_third_party//tensorflow:freebsd": ["-ldl", "-lm", "-lpthread", "-lexecinfo"],
...
def llvm_support_platform_specific_srcs_glob():
    return select({
        "@cc_third_party//tensorflow:windows": native.glob([
