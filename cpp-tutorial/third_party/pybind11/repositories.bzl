...
def pybind11_repo(COMMIT = "2.7.0"):
    maybe(
        http_archive,
        name = "pybind11",
        urls = [
            "https://github.com.cnpmjs.org/pybind/pybind11/archive/v{}.tar.gz".format(COMMIT),
...
def pybind11_bazel_repo(COMMIT = "26973c0ff320cb4b39e45bc3e4297b82bc3a6c09"):
    maybe(
        ...
        name = "pybind11_bazel",
        urls = [
            "https://github.com.cnpmjs.org/pybind/pybind11_bazel/archive/{}.zip".format(COMMIT),
